...
import frc.robot.lib.jetsoninterface.model.Calib;
...
public class OpencvJsonTest {
    public class FrameInfo {
        ...
        public void findAndDrawPoints()
        {
            ...
            if (found) {
                Robot.debugStream.println("Found chessboard corners!");
                ...
                Robot.debugStream.println("Could NOT find chessboard corners!");
            }
        }
    ...
    public void run()
    {
        ...
        for (int i = 0; i < imageFiles.length; i++) {
            ...
            try {
               frame.readOriginalFrame();
                ...
                Robot.debugStream.println(frame.toString());
                throw e;
            }
            Robot.debugStream.println(frame.toString());
        ...
        Robot.debugStream.println("Number of successes=" + numSuccesses);
        if (numSuccesses > 5) {
            ...
            Robot.debugStream.println("Calibration successful! reprojection error=" + reprojectionError);
            ...
            try {
                writer.writeValue(Robot.debugStream, newCalib);
            } catch (IOException e) {
