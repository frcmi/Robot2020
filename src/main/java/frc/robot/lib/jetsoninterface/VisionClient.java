...
public class VisionClient {
    ...
    public VisionClient(String serverUrl) {
        ...
        Robot.debugStream.println("Initializing VisionClient-->" + serverUrl);
    ...
    public void setDeltaProperty(String name, Delta value) {
        SimpleResponse resp = proxy.setDeltaProperty(name, value);
        if (!resp.success) {
            throw new VisionException(resp.error);
        }
    }

    public Delta getDeltaProperty(String name) {
        GetDeltaPropertyResponse resp = proxy.getDeltaProperty(name);
        if (!resp.success) {
            throw new VisionException(resp.error);
        }
        return resp.data;
